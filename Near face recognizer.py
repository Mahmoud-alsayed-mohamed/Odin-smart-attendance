...
layout = [
          [sg.Text('Professor you will take live picture of class without etteration by run this app')], 
...
##print("*************************************************************************************")
##print("_______ This is the material list Select Your material please__________") 
...
attendance=[{"name":"null"},{"name":"null2"}]
...
############crop works but needs to built a function inside the loop##########
image = image[200:1900,300:3600]
########### *********** ##############
...
#######
##attendance2 = [material,date_time]
##number = len(attendance)
##print(attendance2)

##for u in range(2,number,1):
##    attendance2.append(attendance[u].get("name"))
##print(attendance2)
