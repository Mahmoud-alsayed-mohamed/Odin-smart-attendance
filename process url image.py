...
layout = [
          ...
          [sg.Text('please input the url of the image', size=(35, 1))],
	  [sg.InputText()],
          [sg.Submit(), sg.Cancel()]      
         ]
...
resource = urllib.request.urlopen(your_Photo)
with resource as url:
    output = open("attendance.jpg","wb")
    output.write(resource.read())
    output.close()
print("Grabbing the image has done")
