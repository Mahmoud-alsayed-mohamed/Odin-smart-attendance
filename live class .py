...
## layout to enter material

layout = [
          [sg.Text('Professor you will take live picture of class by run this app')],
...
# take image and work on it
cap = cv2.VideoCapture(0)
sample = "sample.jpg"
for testa in range(4):
    ret, img = cap.read()
    time.sleep(3)
...
##    print(attendance2)
    ...
    #r = requests.post('http://192.168.43.118:3000/api/ninjas', data=payload)
    ##result = simplejson.loads(str(r.content))
